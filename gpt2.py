...
class MLP(nn.Module):
    def __init__(self, config):
        ...
        self.gelu    = nn.GELU(approximate='tanh') # GELU siempre aporta cambios.
...
class Block(nn.Module):
    def __init__(self, config):
        ...
        self.attn = CasualSelfAttention(config) # módulo de atención: Donde los tokens intercambian información
